...
import { CheckCircle, Building2, Sparkles, X, Upload } from "lucide-react";
...
export default function ApplyVendor() {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.broker_types.length === 0) {
      toast.error("Please select at least one broker type");
      return;
    }
  ...
  const toggleCommercialFinanceSubcategory = (value) => {
    setFormData(prev => ({
      ...prev,
      commercial_finance_subcategories: prev.commercial_finance_subcategories.includes(value)
          ...
          {[
            {
              ...
              description: "Get connected with brokers actively looking for your services"
            },
            {
              title: "Increased Visibility",
              description: "Showcase your business to a targeted audience of finance professionals"
            },
            {
              title: "Verified Listing",
              description: "Build trust with our vetting process and quality badge"
            }
          ].map((benefit, idx) => (
        ...
        <Card className="max-w-3xl mx-auto shadow-lg">
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  {formData.logo_url ? (
                    ...
                    <label 
                      className={`flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${uploading ? 'bg-gray-100 cursor-not-allowed' : 'hover:bg-gray-50'}`}
                    >
                      {uploading ? (
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-base">Service Categories * <span className="text-sm font-normal text-gray-500">(Select all that apply)</span></Label>
                      ...
                      {commercialFinanceSubcategories.map(subcat => (
                        <div key={subcat.value} className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={() => toggleCommercialFinanceSubcategory(subcat.value)}
                          />
                          <label
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-base">Target Broker Types * <span className="text-sm font-normal text-gray-500">(Select all that apply)</span></Label>
                  <div className="grid md:grid-cols-2 gap-3 mt-3">
