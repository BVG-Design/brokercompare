          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="p-6 rounded-xl border bg-card shadow-sm space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                Account details, usage data, and feedback you choose to share help us personalize recommendations and support.
              </p>
            </div>
            <div className="p-6 rounded-xl border bg-card shadow-sm space-y-3">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-accent/10">
              ...
              <p className="text-sm text-muted-foreground">
                To deliver services, improve search and benchmarking, secure the platform, and communicate important updates.
              </p>
            </div>
            <div className="p-6 rounded-xl border bg-card shadow-sm space-y-3">
              <div className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-accent/10">
              ...
              <p className="text-sm text-muted-foreground">
                You can update preferences, opt out of marketing, and request access, correction, or deletion of personal data.
              </p>
            </div>
          </div>
