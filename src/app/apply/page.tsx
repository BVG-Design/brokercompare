...
export default function ApplyVendor() {
  ...
  const categories = [
    ...
    {
      value: 'accounting_software_services',
      label: 'Accounting Software or Services',
    },
    { value: 'credit_reporting', label: 'Credit Reporting' },
    {
      value: 'fraud_checks_id_verification',
      label: 'Fraud Checks and ID Verification',
    },
  ...
  const commercialFinanceSubcategories = [
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.broker_types.length === 0) {
      toast({
        title: 'Error',
        description: 'Please select at least one broker type',
        variant: 'destructive',
      });
      return;
    }
  ...
  const toggleCommercialFinanceSubcategory = (value: string) => {
    setFormData((prev) => ({
      ...prev,
      commercial_finance_subcategories:
        prev.commercial_finance_subcategories.includes(value)
          ? prev.commercial_finance_subcategories.filter((c) => c !== value)
          : [...prev.commercial_finance_subcategories, value],
    }));
  };

  const toggleBrokerType = (value: string) => {
    setFormData((prev) => ({
      ...prev,
      broker_types: prev.broker_types.includes(value)
        ? prev.broker_types.filter((b) => b !== value)
        : [...prev.broker_types, value],
    }));
  };
  ...
  const showCommercialFinanceSubcategories =
    formData.categories.includes('commercial_finance');
  const showCategoryOther = formData.categories.includes('other');
  const showBrokerTypeOther = formData.broker_types.includes('other');
  const showCommercialFinanceOther =
    formData.commercial_finance_subcategories.includes('other');
  const showReferralName = formData.referral_source === 'friend_referral';

  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#132847] to-[#1a3a5f] text-white py-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            List Your Business
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Join our directory and connect with brokers looking for your
            solutions
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {[
            {
              ...
              description:
                'Get connected with brokers actively looking for your services',
              icon: Users,
            },
            {
              title: 'Increased Visibility',
              description:
                'Showcase your business to a targeted audience of finance professionals',
              icon: Eye,
            },
            {
              title: 'Verified Listing',
              description:
                'Build trust with our vetting process and quality badge',
              icon: ShieldCheck,
            },
          ].map((benefit, idx) => (
            <Card key={idx} className="border-[#05d8b5]/20">
              <CardContent className="pt-6">
                ...
                <h3 className="text-lg font-bold text-[#132847] mb-2">
                  {benefit.title}
                </h3>
        ...
        <Card className="max-w-3xl mx-auto shadow-lg">
          <CardHeader className="bg-gradient-to-r from-gray-50 to-white border-b">
            <CardTitle className="text-2xl text-[#132847]">
              Application Form
            </CardTitle>
          ...
          <CardContent className="pt-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-[#132847]">
                  Business Type *
                </h3>
                <RadioGroup
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    Upload a square logo (recommended 400x400px)
                  </p>
                  {formData.logo_url ? (
                    ...
                    <label
                      className={`flex flex-col items-center justify-center w-32 h-32 border-2 border-dashed rounded-lg cursor-pointer transition-colors ${uploading
              ...
              <div className="space-y-4">
                ...
                {showCommercialFinanceSubcategories && (
                  <div className="border-l-4 border-[#05d8b5] pl-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-3 mt-3">
                      {commercialFinanceSubcategories.map((subcat) => (
                        <div
                          key={subcat.value}
                          className="flex items-center space-x-2"
                        >
                          <Checkbox
                            id={`cf_${subcat.value}`}
                            checked={formData.commercial_finance_subcategories.includes(
                              subcat.value
                            )}
                            onCheckedChange={() =>
                              toggleCommercialFinanceSubcategory(
                                subcat.value
                              )
                            }
                          />
                          <label
                            htmlFor={`cf_${subcat.value}`}
                            className="text-sm text-gray-700 cursor-pointer"
                          >
                            {subcat.label}
                          </label>
                    ...
                    {showCommercialFinanceOther && (
                      <div className="mt-3">
                        <Label htmlFor="commercial_finance_other">
              ...
              <div className="space-y-4">
                    ...
                    {brokerTypes.map((type) => (
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={() => toggleBrokerType(type.value)}
                        />
                        <label
                          htmlFor={type.value}
                          className="text-sm text-gray-700 cursor-pointer"
                ...
                {showBrokerTypeOther && (
                  <div>
                    <Label htmlFor="broker_type_other">
                      Please specify other broker type
                    </Label>
                    <Input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          broker_type_other: e.target.value,
                        })
                      }
              ...
              <div>
                <Label htmlFor="product_service_features">
                  Product/Service Features
                </Label>
                <Textarea
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      product_service_features: e.target.value,
                    })
                  }
                  rows={4}
              ...
              <div>
                <Label htmlFor="integrations">
                  Do you integrate or work with other software?
                </Label>
                <Textarea
                  id="integrations"
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="pricing_structure">
                    Pricing Structure
                  </Label>
                  <Select
                    value={formData.pricing_structure}
                    onValueChange={(value) =>
                      setFormData({ ...formData, pricing_structure: value })
                    }
                  >
                    <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          pricing_details: e.target.value,
                        })
                      }
                      rows={3}
              ...
              <div>
                <Label htmlFor="why_join">
                  Why do you want to join our directory? *
                </Label>
                <Textarea
                  id="why_join"
              ...
              <div className="pt-4 border-t">
                ...
                <p className="text-sm text-gray-500 mt-4">
                  * All applications are reviewed manually. We&apos;ll get back
