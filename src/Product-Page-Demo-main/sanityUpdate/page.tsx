...
export default async function Home() {
    ...
    const featuredBlogs = await client.fetch(FEATURED_BLOGS_QUERY);
    ...
    const services = featuredBlogs.map((blog: any) => ({
                    ...
                    <div className="container mx-auto px-4 md:px-6">
                        <div className="text-center space-y-3 mb-12">
                            ...
                            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                                Services that generate leads and support your broker business.
                            </p>
                        </div>
                            ...
                            {services.map((service: any, index: number) => (
                                <Card key={service.title} className="overflow-hidden group flex flex-col">
                                    ...
                                    <CardContent className="p-6 flex-1 flex flex-col">
                                        ...
                                        <Button asChild variant="link" className="p-0 text-secondary self-start">
                            ...
                            <div>
                                ...
                                <ul className="mt-6 space-y-4">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <span>Access quality service providers.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Check className="h-6 w-6 text-accent flex-shrink-0 mt-1" />
