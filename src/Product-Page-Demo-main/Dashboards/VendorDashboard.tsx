                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                      ...
                      <div className={`border-2 rounded-xl p-6 ${vendor.listing_tier === 'featured' ? 'border-[#ef4e23] bg-gradient-to-br from-[#ef4e23]/5 to-[#05d8b5]/5' : 'border-[#ef4e23]'}`}>
                        ...
                        <p className="text-3xl font-bold text-[#132847] mb-4">Custom<span className="text-sm text-gray-600">/mo</span></p>
                        <ul className="space-y-3 mb-6">
                          <li className="flex items-start gap-2">
                            <CheckCircle className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
                        ...
                        {vendor.listing_tier === 'featured' ? (
                          ...
                          <Link to={createPageUrl('UpgradePartnership')}>
                    ...
                    <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded-lg">
                      <h4 className="font-semibold text-[#132847] mb-2">Need a Custom Package?</h4>
                      <p className="text-sm text-gray-600 mb-4">
                        Looking for something specific? We offer flexible partnership packages tailored to your needs.
                      </p>
                      <Link to={createPageUrl('UpgradePartnership')}>
                        <Button variant="outline" className="border-[#132847] text-[#132847]">
