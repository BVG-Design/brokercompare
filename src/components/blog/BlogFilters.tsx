            ...
            <div className="bg-transparent text-left">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-bold text-brand-blue text-sm uppercase tracking-wider">Refine Results</h3>
                    </div>
                    {hasActiveFilters && (
                        <Button
                            variant="link"
                            ...
                            className="text-brand-orange hover:text-brand-orange/80 p-0 h-auto text-[10px] font-bold uppercase tracking-widest"
                        >
                            Reset All
                        </Button>
                    )}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-brand-blue uppercase tracking-widest ml-1">Category</label>
                        <Select
                            value={currentCategory}
                            onValueChange={(val) => updateFilters('category', val)}
                        >
                            <SelectTrigger className="h-10 bg-white border-brand-blue/5 text-brand-blue text-xs rounded-xl shadow-sm focus:ring-2 focus:ring-brand-orange/20 hover:border-brand-orange/20 transition-all font-bold">
                                <SelectValue placeholder="All categories" />
                            </SelectTrigger>
                            <SelectContent className="rounded-xl border-brand-blue/5 shadow-2xl">
                    ...
                    {/* Broker Type Filter */}
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-brand-blue uppercase tracking-widest ml-1">Broker Type</label>
                        <Select
                    ...
                    {/* Blog Type Filter */}
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-brand-blue uppercase tracking-widest ml-1">Article Type</label>
                        <Select
                    ...
                    {/* Co-Hosts Filter */}
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-brand-blue uppercase tracking-widest ml-1">Co-Hosts</label>
                        <Select
                            value={currentAuthor}
